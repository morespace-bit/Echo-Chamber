...
export default function Feed() {
  ...
  return (
    // main container
    <div className="bg-gray-200 dark:bg-gray-800 text-black dark:text-white overflow-x-hidden relative">
      {/* the message after reporting  */}
      {msg && (
        <div className="absolute top-10 p-5 bg-red-300 rounded-2xl w-90 left-5 md:left-150 shadow-2xl text-center tracking-wider z-10">
          <p>{msgContent}</p>
        </div>
      )}
